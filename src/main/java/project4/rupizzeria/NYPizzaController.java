...
/**
 * NYPizza controller for the NYPizzaView.fxml
...
public class NYPizzaController {
    ...
    /**
     * method to set the type of the pizza. Called everytime the choice box is used. Calls to set
     * image type, get the crust of the pizza, and get toppings
     * @param pizzaTypeBox ChoiceBox
     * @return String with the pizza type
     */
    private String setType(ChoiceBox pizzaTypeBox){
        messages.setText("");
    ...
    /**
     * set the image of the pizza
     */
    private void setPizzaImage(){
        if (type.equalsIgnoreCase("Deluxe")){
            Image deluxeImage = new Image(getClass().getResourceAsStream("DeluxeNYPizza.png"));
            pizzaImage.setImage(deluxeImage);
        } else if (type.equalsIgnoreCase("BBQ Chicken")){
            Image bbqChickenImage = new Image(getClass().getResourceAsStream("BBQChickenNYPizza.png"));
            pizzaImage.setImage(bbqChickenImage);
        } else if (type.equalsIgnoreCase("Meatzza")){
            Image meatzzaImage = new Image(getClass().getResourceAsStream("MeatzzaNYPizza.png"));
            pizzaImage.setImage(meatzzaImage);
        } else if (type.equalsIgnoreCase("Build Your Own")){
            Image byoImage = new Image(getClass().getResourceAsStream("1-NYPizza.png"));
    ...
    /**
     * get crust method to get the crust type
     * @return Crust
     */
    private Crust getCrust(){
        return Crust.getCrust(type, "New York");
    }
    ...
    public void addToCurrentOrder(){
        ...
        if (error.isBlank()){
            NYPizza nypzza = new NYPizza();
            // type is selected automatically when the user uses the dropdown box
            if (type.equalsIgnoreCase("Build Your Own")){
                pizza = nypzza.createBuildYourOwn();
            } else if (type.equalsIgnoreCase("Deluxe")) {
                pizza = nypzza.createDeluxe();
            } else if (type.equalsIgnoreCase("BBQ Chicken")) {
                pizza = nypzza.createBBQChicken();
            } else if (type.equalsIgnoreCase("Meatzza")) {
                pizza = nypzza.createMeatzza();
            }
            ...
            if (MainViewController.currOrder.add(pizza)){
                messages.setText(size.toString().toUpperCase() + " New York "+ type + " style pizza \n has been added to current order");
            } else {
                messages.setText(size.toString().toUpperCase() + " New York " + type + " pizza could not be added");
            }
    ...
    /**
     * Cancel new york pizza order. It goes back to main menu
